...
| **C8** Inicio Ejecutivo               | la pantalla principal (10 bloques)      | 🟡 **construido FE-first/gated** (#286 `dashboardSummary`) — antes placeholder/MVP perfil                                                           | `GET /api/dashboard/summary` (no existe; entrega incremental acordada)     |
