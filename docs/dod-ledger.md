...
| **C7** | Pulso Empresa                                            | 🟢 bloque LIVE en C8                         | `dashboardSummary` ON  | bloque Pulso dentro del summary (LIVE 2026-06-03)                           | pantalla `gestion/pulso` dedicada (opcional) |
| **C8** | Inicio Ejecutivo                                         | ✅ **LIVE** (2026-06-03)                     | `dashboardSummary` ON  | #286/#296; endpoint expuesto (cookie) + tipos generados + flag ON en prod   | — (drivers/pulso dedicados = C6/C7)          |
