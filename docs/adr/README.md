...
| [0007](./0007-estructura-carpetas-dominios-addendum.md)                | Mantener `src/components/` + `src/lib/api/` (no `src/features/`)                                 | Accepted              | 2026-05-15 |
...
| [0009](./0009-politica-drag-and-drop.md)                               | Política de drag-and-drop para árboles de gestión (preventiva)                                   | Accepted (preventiva) | 2026-05-15 |
| [0010](./0010-selectores-sin-libreria-combobox.md)                     | Selectores de clasificación sin librería combobox (dependency-free)                              | Accepted              | 2026-05-16 |
