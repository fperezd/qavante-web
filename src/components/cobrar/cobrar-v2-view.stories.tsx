...
/* Cobrar v2 (rediseño lente Xero). Container con `useAccountsReceivable` — mismo
   data layer y contrato FE-first que el v1 (endpoint aún no existe) → MSW
...
const meta = {
  title: "Capa 2 / Cobrar / CobrarV2View",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Cobrar v2 (rediseño lente Xero): jerarquía nueva — lo vencido (lo accionable) es el héroe, no el total; top deudores como cards 'a quién cobrarle primero'; documentos vencidos que reflowean a cards en mobile (sin scroll horizontal). Mantiene el aging bar segmentado del v1. Mismo data layer y contrato FE-first.",
      },
    },
    msw: { handlers: [OK] },
  },
