...
/* Tira compacta de KPIs — una sola tarjeta con celdas divididas, más densa que N
 * tarjetas grandes. Compartida por los paneles de control de gestión (Libro, BHE). */
