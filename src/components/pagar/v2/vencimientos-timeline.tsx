        ...
        return (
          <li key={it.id}>
            <button
              type="button"
              onClick={it.onClick}
              className="group relative grid w-full grid-cols-[76px_1fr_auto] items-center gap-3 py-2.5 pl-4 pr-8 text-left transition-colors hover:bg-surface-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary"
            >
              ...
              <ChevronRight
                className="pointer-events-none absolute right-2.5 size-4 text-neutral-light group-hover:text-brand-primary"
                aria-hidden="true"
              />
            </button>
          </li>
