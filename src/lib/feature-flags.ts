...
export const FLAG_GATING_ENDPOINT: Record<FeatureFlag, string> = {
  ...
  /* Cobrar v2 (rediseño 2026-07-19) — respuesta de dueño: "a quién le cobras primero" + acciones
     ...
     dos modos según haya o no vencimientos del SII (urgencia vs. concentración). Con ON tiene
     prioridad sobre la vista clásica de Cobrar; hoy OFF, el Cobrar clásico queda intacto. */
  cobrarV2: "/api/treasury/accounts-receivable",
